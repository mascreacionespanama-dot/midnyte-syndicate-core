          ...
          <div className="max-w-7xl mx-auto">
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <p className="text-muted-foreground text-xs tracking-wide mt-2">The next drop is loading.</p>
              </div>
            ) : (
                ...
                {products.map((product, i) => (
                  ...
                  >
                    ...
                    <div className="pt-6 pb-8">
                      ...
                      <p className="text-muted-foreground text-xs mt-2 tracking-wide leading-relaxed line-clamp-2">
