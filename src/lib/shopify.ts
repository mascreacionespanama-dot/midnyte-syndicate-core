...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'wk0p37-rb.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '05edc746c50917fcdfc505696b878477';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Store requires an active billing plan", {
      description: "Visit your Shopify admin to upgrade.",
    });
    return;
  }
